...
class NetworkManager {
    ...
    class Request {
        ...
        class func new<T: Decodable>(urlString: String, method: NetworkMethod, headers: [String: String]? = nil, parameters: [String: String]? = nil, id: Int? = nil, _ handler: NetworkResultHandler<T>?) {
            ...
            case .DELETE: self.delete(urlString: urlString, headers: headers, handler: handler)
            }
        }
        ...
        private class func delete<T: Decodable>(urlString: String, headers: [String: String]?, handler: NetworkResultHandler<T>?) {
            rawDelete(urlString: urlString, headers: headers) { (result) in
                rawResultTranslator(rawResult: result, resultHandler: handler)
            }
        }
        ...
        ///   - headers: 기본 Header에 덧붙일 header
        ///   - completion: 요청후 실행하는 Handler
        private class func rawDelete(urlString: String, headers: [String: String]?, completion: NetworkRawResultHandler?) {
            request(urlString, "DELETE", completion, headers)
        }
        ...
        private class func request(_ urlString: String, _ httpMethod: String, _ completion: NetworkRawResultHandler?, _ headers: [String: String]?, _ parameters: [String: String]? = nil) {
